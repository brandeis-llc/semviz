...
We are developing semantic visualization techniques in order to enhance  exploration and enable discovery over large datasets of complex networks of relations. <i>Semantic visualization</i> refers to the process of (i) indexing all terms and NLP-extracted named entities, relations, and knowledge graphs from the original data source; (ii) creating semantic Wordclouds and heatmaps for  all relevant entities and relations; (iii) applying <i>parameter reduction</i> operations to relations, resulting in <it>relation containers</i> that are functional entities that visualize as wordclouds; embedding relation containers as parameters in heatmaps, in order to visualize multiple relations and partial pathways of relations  within a single heatmap display. 
