...
We are developing semantic visualization techniques in order to enhance  exploration and enable discovery over large datasets of complex networks of relations. <i>Semantic visualization</i> refers to the process of (i) indexing all terms and NLP-extracted named entities, relations, and knowledge graphs from the original data source; (ii) Create Wordclouds and heatmaps for  all relevant entities and relations; (iii) apply <i>parameter reduction</i> operations to relations, in order to visualize multiple relations or relational pathways within heatmap displays. 
